...
const get_area_as_png_1 = require("../lib/get-area-as-png");
...
class PdfHighlighter extends react_1.PureComponent {
    ...
    screenshot(position, pageNumber, contextPosition) {
        const canvas = this.viewer.getPageView(pageNumber - 1).canvas;
        return contextPosition == null
            ? (0, get_area_as_png_1.getAreaAsPNG)(canvas, position)
            : (0, get_area_as_png_1.getAreaAsPngWithContext)(canvas, position, contextPosition);
    }
        ...
        return (react_1.default.createElement("div", { onPointerDown: this.onMouseDown },
            react_1.default.createElement("div", { ref: this.containerNodeRef, className: "PdfHighlighter", onContextMenu: (e) => e.preventDefault() },
                ...
                typeof enableAreaSelection === "function" ? (react_1.default.createElement(MouseSelection_1.default, { onDragStart: () => this.toggleTextSelection(true), onDragEnd: () => this.toggleTextSelection(false), onChange: (isVisible) => this.setState({ isAreaSelectionInProgress: isVisible }), shouldStart: (event) => enableAreaSelection(event) &&
                        ...
                        const imageWithContext = this.screenshot(Object.assign(Object.assign({}, pageBoundingRect), { top: pageBoundingRect.top - contextTop }), pageBoundingRect.pageNumber, Object.assign(Object.assign({}, pageBoundingRect), { top: contextTop, left: page.node.clientLeft, width: page.node.offsetWidth, height: partialHeight }));
                        this.setTip(viewportPosition, onSelectionFinished(scaledPosition, { image, imageWithContext }, () => this.hideTipAndSelection(), () => {
