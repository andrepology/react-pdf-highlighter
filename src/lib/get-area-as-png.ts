...
export const getAreaAsPNG = (canvas: HTMLCanvasElement, position: LTWHP, extendedRenderer?: (newCanvas: CanvasRenderingContext2D) => void): string => {
...
export const getAreaAsPngWithContext = (canvas: HTMLCanvasElement, position: LTWHP, contextPosition: LTWHP): string => {
